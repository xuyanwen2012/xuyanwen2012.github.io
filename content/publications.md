...
- **BetterTogether: An Interference-Aware Framework for Fine-grained Software Pipelining on Heterogeneous SoCs.**
  ...
  - [[pdf](pdf-iiswc.pdf)] [[slides](pdf-iiswc-slides.pdf)] [[code](https://github.com/ucsc-redwood/better-together)] [[DOI](https://ieeexplore.ieee.org/document/11242071)]
...
- **Redwood: Flexible and Portable Heterogeneous Tree Traversal Workloads.**
  ...
  - [[pdf](pdf-ispass.pdf)] [[slides](pdf-ispass-slides.pdf)] [[code](https://github.com/ucsc-redwood/redwood-aio)] [[DOI](https://ieeexplore.ieee.org/document/10158162)]
